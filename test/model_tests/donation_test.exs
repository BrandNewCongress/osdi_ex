defmodule DonationTest do
  ...
  test "fundraising page creation" do
    fp = Repo.insert!(%FundraisingPage{title: "title", description: "description", summary: "summary",
      browser_url: "https://www.jd.com", administrative_url: "https://admin.jd.com",
      featured_image_url: "https://featured.jd.com", currency: "USD",
      share_url: "https://share.jd.com", name: "fp-name"})
  ...
  test "direction donation creation" do
    fp = %FundraisingPage{}
      |> FundraisingPage.changeset(%{title: "with donatiosn", description: "this one will have donations", summary: "summary",
        browser_url: "https://www.jd.com", administrative_url: "https://admin.jd.com",
        featured_image_url: "https://featured.jd.com", currency: "USD",
        share_url: "https://share.jd.com", name: "fp-dummy-name"})
      |> Repo.insert!()
    ...
    new_donation = Donation.changeset(donation, %{
      ...
      person: person, fundraising_page: fp
    })
